...
echo "Preview real-time intervention decisions:"
echo "kafka-console-consumer.sh --bootstrap-server $BOOTSTRAP_SERVER --topic driver_interventions --from-beginning --max-messages 5"
